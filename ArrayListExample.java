package array;
	...
	public class ArrayListExample { //creating the class name as ArraListExample
		...
		public static void main(String[] args) { //creating main method 
			...
			ArrayList <Integer> studentMarks =new  ArrayList<Integer>(); //here I'm creating an array list of student marks of type integer 
			 ...
			 studentMarks.add (40); //creating the list objects and initializing the variables  in it 
			 studentMarks.add (60);
			 studentMarks.add (70);
			 studentMarks.add (80);
			 studentMarks.add (90);
			...
			studentMarks.set(2, 40);    //here I'm replacing the third element 53 which of Array index 2 by the value 40
